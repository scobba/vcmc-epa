...
**[my-evaluations/index.html](my-evaluations/index.html) shows one learner their own record**, and is the only page where being signed in does not mean seeing everything. Residents get their EPA averages by rotation, their milestone averages in half-steps, and every evaluation in full including the narrative — but **not the evaluator's name**, which is a deliberate default rather than an oversight: un-hiding it later is one line, while un-showing attributed criticism is impossible.
